...
(()=>{
    ...
    document.addEventListener('keydown', (e)=>{
        ...
        if (pressed === keys[currentKeyIndex]) {
            if (window.PNotify && window.PNotify.success) PNotify.success({
                text: "\u041F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u043E!",
                delay: 900
            });
            else console.log("\u041F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u043E!");
            setCurrentKeyByIndex(getRandomIndex());
        } else if (window.PNotify && window.PNotify.error) PNotify.error({
            text: `\u{41D}\u{435}\u{43F}\u{440}\u{430}\u{432}\u{438}\u{43B}\u{44C}\u{43D}\u{43E} \u{2014} \u{43D}\u{443}\u{436}\u{43D}\u{43E} "${keys[currentKeyIndex]}"`,
            delay: 1400
        });
        else console.log(`\u{41D}\u{435}\u{43F}\u{440}\u{430}\u{432}\u{438}\u{43B}\u{44C}\u{43D}\u{43E} \u{2014} \u{43D}\u{443}\u{436}\u{43D}\u{43E} "${keys[currentKeyIndex]}"`);
    });
    ...
    newGameBtn.addEventListener('click', ()=>{
        setCurrentKeyByIndex(getRandomIndex());
        if (window.PNotify && window.PNotify.info) PNotify.info({
            text: "\u041D\u043E\u0432\u0430\u044F \u0438\u0433\u0440\u0430 \u0437\u0430\u043F\u0443\u0449\u0435\u043D\u0430. \u0416\u043C\u0438 \u043A\u043B\u0430\u0432\u0438\u0448\u0443!",
            delay: 1200
        });
    });
})();
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}]},["j7Itq","9VLDe"], "9VLDe", "parcelRequire6952", {})

//# sourceMappingURL=canvas.45a87f56.js.map
